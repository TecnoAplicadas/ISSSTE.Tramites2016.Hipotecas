...
namespace ISSSTE.Tramites2016.Common.Catalogs
{
    ...
    public interface ICatalogRepository
    {
        ...
        Task<ICollection<TObject>> GetAllAsync<TObject>(string catalogName) where TObject : class;
        ...
        /// <returns>The resulting updated object</returns>
        Task<TObject> AddOrUpdateAsync<TObject>(TObject updated, string catalogName) where TObject : class;
        ...
        Task<int> DeleteAsync<TObject>(TObject t, string catalogName) where TObject : class;
