...
namespace ISSSTE.Tramites2016.Common.Catalogs.Implemantions
{
    /// <summary>
    ...
    public class CatalogReflexionHelper : ICatalogReflexionHelper
    {
        ...
        {
            return await InvokeAsyncGenericMethod<T>(repository, GetAllAsyncMethodName, catalogName, new object[] { catalogName });
        }
        ...
        public async Task<T> InvokeGetAsync<T>(ICatalogRepository repository, string catalogName, string key)
        {
            ...
            return await InvokeAsyncGenericMethod<T>(repository, GetAsyncMethodName, catalogName, new object[] { new object[] { convertedParameter, catalogName } });
        }
