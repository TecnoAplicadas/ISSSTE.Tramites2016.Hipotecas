...
namespace ISSSTE.Tramites2016.Common.Mail
{
    ...
    public class MailService : IMailService
    {
        ...
        public void SendMailAsync(string senTomail, string subject, string body)
        {
            SendMailAsync(new List<string> {senTomail}, null, null, subject, body, null, null, _masterpage);
        }

        /// <summary>
        ///     Envía un correo electrónico con la información proporcionada
        /// </summary>
        public void SendMailAsync(List<string> recipient, List<string> carbonCopy, List<string> blackCarbonCopy,
        ...
        {
            SendMailAsync(new List<string> { senTomail }, null, null, subject, body, null, null, MasterPageParameters.LoadFromFile(masterPageAbsolutePath, logoAbsolutePath));
        }
