namespace ISSSTE.Tramites2016.Common.Security.Owin
{
    ...
    public class IsssteTramitesConstants
    {
        ...
        public static string BaseUrl
        {
            get
            {
                return ConfigurationManager.AppSettings["ISSSTE.Tramites2016.Common.Security.Owin.Constants.Server.WSBaseUrl"];
            }
        }
        ...
        public static string TokenUrl
        {
            get
            {
                return ConfigurationManager.AppSettings["ISSSTE.Tramites2016.Common.Security.Owin.Constants.Client.TokenUrl"];
            }
        }
        ...
        public static string TokenValidationUrl
        {
            get
            {
                return ConfigurationManager.AppSettings["ISSSTE.Tramites2016.Common.Security.Owin.Constants.Server.TokenValidationUrl"];
            }
        }
        ...
        public static string LogoutUrl
        {
            get
            {
                return ConfigurationManager.AppSettings["ISSSTE.Tramites2016.Common.Security.Owin.Constants.Client.LogoutUrl"];
            }
        }
        ...
        public static string LoginUrl
        {
            get
            {
                return ConfigurationManager.AppSettings["ISSSTE.Tramites2016.Common.Security.Owin.Constants.Client.LoginUrl"];
            }
        }
