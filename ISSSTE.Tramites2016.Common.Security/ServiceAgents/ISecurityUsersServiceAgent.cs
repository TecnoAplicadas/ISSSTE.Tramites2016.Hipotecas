...
namespace ISSSTE.Tramites2016.Common.Security.ServiceAgents
{
    /// <summary>
    ...
    public interface ISecurityUsersServiceAgent
    {
        ...
        Task<List<SimpleUser>> GetUsersByProcedureAndRoleAsync(IOwinContext owinContext, Guid procedureId, int roleId);
    }
}
