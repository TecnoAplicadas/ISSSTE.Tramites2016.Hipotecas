(function() {
    ...
    commonModule.provider("commonConfig", function() {
        this.config = {
            ...
            information: {},
            requestInf: {},
            ISSSTE_NUMBER_QUERY_PARAM: "noissste",
            ID_PENSION_QUERY_PARAM: "pensionId",
            ID_REQUEST_QUERY_PARAM: "requestId",
            ID_CURP_PARAM: "curp"
    ...
    commonModule.factory("common", ["$q", "$rootScope", "$timeout", "commonConfig", "appConfig", "logger", "$location", common]);

    function common($q, $rootScope, $timeout, commonConfig, appConfig, logger,$location) {
        var service = {
