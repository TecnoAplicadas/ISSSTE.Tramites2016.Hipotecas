...
// http://caniuse.com/#search=transition
    ...
    var $$AnimateCssDriverProvider = [
        "$$animationProvider", function($$animationProvider) {
            ...
            this.$get = [
                "$animateCss", "$rootScope", "$$AnimateRunner", "$rootElement", "$document", "$sniffer",
...
//  by the time...
    ...
    var $$AnimateJsProvider = [
        "$animateProvider", function($animateProvider) {
            this.$get = [
                "$injector", "$$AnimateRunner", "$$rAFMutex", "$$jqLite",
    ...
    var $$AnimateRunnerFactory = [
        "$q", "$$rAFMutex", function($q, $$rAFMutex) {
            var INITIAL_STATE = 0;
    ...
    var $$AnimationProvider = [
        "$animateProvider", function($animateProvider) {
            ...
            this.$get = [
                "$$jqLite", "$rootScope", "$injector", "$$AnimateRunner", "$$rAFScheduler",
