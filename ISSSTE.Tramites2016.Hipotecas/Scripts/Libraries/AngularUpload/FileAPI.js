    ...
    XHR.prototype = {
        ...
        _send: function(options, data) {
            ...
            if (data.nodeName) {
                ...
                var
                    form = xhr.getElementsByTagName("form")[0], transport = xhr.getElementsByTagName("iframe")[0];
                ...
                if (options._chunked) {
                    ...
                    var
                        file = data.file, slice = (file.slice || file.mozSlice || file.webkitSlice).call(file, data.start, data.end + 1);
                    ...
                    mouseover: function(evt) {
                        if (!flash.disableMouseover) {
                            ...
                            if (/input/i.test(target.nodeName) && target.type == "file" && !target.disabled) {
                                var
                                    state = target.getAttribute(_attr), wrapper = flash.getWrapper(target);
