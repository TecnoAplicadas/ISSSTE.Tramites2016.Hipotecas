            ...
            function ($log) {
                var reset = function (el) {
                    angular.forEach(el.find("span"), function (spanEl) {
                        ...
                        if (spanEl.hasClass('form-text-error')) {
                            spanEl.removeClass('form-text-error');
                        }
                    });
                    ...
                    makeInvalid = function (el, errorMsg) {
                        var frmGroupEl = findFormGroupElement(el),
                            helpTextEl = angular.element("<small><span class=\"help-block has-error error-msg\">" + errorMsg + "</span></small>"),
                            inputGroupEl;
...
(function (String, angular) {
    ...
    angular.autoValidate.errorMessages["en-us"] = angular.autoValidate.errorMessages["en-gb"] = {
        ...
        min: "Por favor introduce un valor mayor a  {0}",
        max: "Por favor introduce un valor menor a  {0}",
...
(function (angular) {
    ...
    angular.module("jcs-autoValidate").config([
        "$provide",
        function ($provide) {
